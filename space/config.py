...
from space.model.vqspace.arch import arch as vqarch
from space.eval.eval_cfg import eval_cfg
...
if __name__ == '__main__':
  ...
  cfg.merge_from_file('space/configs/procgen.yaml')
  ...
  #     cfg[k] = dict(v)
  print(cfg)
  cfg = oc.OmegaConf.create(cfg)
  with open('config.yaml', 'w') as f:
    oc.OmegaConf.save(cfg, f)
